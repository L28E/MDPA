function AddTriAtomicArray(BaseWidth, X0, Y0, VX0, VY0, InitDist, Temp, Type)
global C
...
for i = 1:BaseWidth
    for j = 1:i
        numAtoms = numAtoms+1;
        x(nAtoms + numAtoms) = offset + (j-1) * AtomSpacing;
        y(nAtoms + numAtoms) = -(i-1) * AtomSpacing;        
    end
    offset=offset-AtomSpacing/2;
end  
